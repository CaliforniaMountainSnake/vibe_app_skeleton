  ...
  return (
    <div className="flex flex-col flex-1 p-4 sm:p-8 max-w-5xl mx-auto w-full gap-6">
        ...
        <CardContent className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              Drag the slider to set the monthly budget for the project.
            </p>
          </div>
      ...
      <p className="text-center text-xs text-muted-foreground pb-4">
        Built with{" "}
        <Badge variant="secondary" className="text-[10px] px-1 py-0">Next.js</Badge>
        {" "}+{" "}
        <Badge variant="outline" className="text-[10px] px-1 py-0">shadcn/ui</Badge>
        {" "}+{" "}
        <Badge variant="secondary" className="text-[10px] px-1 py-0">Tailwind</Badge>
      </p>
    </div>
  );
}
